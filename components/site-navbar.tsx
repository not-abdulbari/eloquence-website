    ...
    <div className="fixed inset-x-0 top-[2vh] z-50 flex justify-center pointer-events-none" aria-hidden={false}>
      ...
      >
        ...
        <div className="flex items-center w-full relative">
          ...
          <Link
            href="/"
            className="flex items-center gap-2 rounded-full px-2 text-[3.5vw] sm:text-base font-semibold tracking-tight text-foreground whitespace-nowrap"
            style={{ fontFamily: 'Decaydence', letterSpacing: '0.01em' }}
          >
            Eloquence &apos;25
          </Link>
          {/* Right: theme toggle, hamburger, register */}
